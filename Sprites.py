...
class Spritesheet:
    ...
    def __init__(self, filename):
        self.spriteesheet = pg.image.load(filename).convert()

    def get_image(self, x, y, width, height):
        # to grap a certain image out of the spritesheet
        image = pg.Surface((width, height))
        image.blit(self.spriteesheet, (0,0), (x,y,width,height))
        image = pg.transform.scale(image,(28,46)) # rescale the cut image, numbers are place holders for now
        return image
...
class Player(pg.sprite.Sprite):
    ...
    def load_player_images(self):
        ...
        self.walking_right_frames = [self.game.player_spritesheet.get_image(51,64,33,56),
                                     self.game.player_spritesheet.get_image(0,64,38,56),
                                     self.game.player_spritesheet.get_image(94,64,38,56)]
...
class Enemy(pg.sprite.Sprite):
    ...
    def load_enemy_images(self ,type):
        self.idle_frames = [self.game.enemy_images[type].get_image(48,123,38,62),
                                     self.game.enemy_images[type].get_image(0,123,38,62),
                                     self.game.enemy_images[type].get_image(91,123,38,62)]
